...
final class PerMonthPerPartWithDateTest extends AbstractMetricsTestCase
{
    ...
    protected function assertResponseIsValid(object $data): void
    {
        ...
        self::assertSame('2018-05-01T00:00:00+00:00', $data->member[11]->date);
        // 2 months of data * (5 parts + no part)
        self::assertSame(12, $data->totalItems);
        self::assertCount(12, $data->member);
    }
