...
final class PerWeekWithDateTest extends AbstractMetricsTestCase
{
    use ValidateJsonSchemaTrait;

    protected function assertResponseIsValid(object $data): void
    {
        self::assertSame('2018-03-26T00:00:00+00:00', $data->member[0]->date);
        self::assertSame('2018-04-16T00:00:00+00:00', $data->member[3]->date);
